...
const struct {
  struct {
	...
	ITEM0(TAG_END_COLLECTION), /* Display attributes */
	...
	ITEM0(TAG_END_COLLECTION), /* Blit report */

	
	/* ITEM0(TAG_END_COLLECTION), */ /* Bitmap display */
#endif
	...
	ITEM0(TAG_END_COLLECTION) /* GPIO board */
#else
	ITEM1(TAG_USAGE_PAGE, USAGE_PAGE_GENERIC_DESKTOP),
	ITEM1(TAG_USAGE, USAGE_CA_MOUSE),
	ITEM1(TAG_COLLECTION, COLLECTION_APPLICATION),
	ITEM1(TAG_USAGE_PAGE, USAGE_PAGE_BUTTON),
	ITEM1(TAG_USAGE_MIN, USAGE_BUTTON(1)),
	ITEM1(TAG_USAGE_MIN, USAGE_BUTTON(3)),
	ITEM1(TAG_LOGICAL_MIN, 0),
	ITEM1(TAG_LOGICAL_MAX, 1),
	ITEM1(TAG_REPORT_COUNT, 3),
	ITEM1(TAG_REPORT_SIZE, 1),
	ITEM2(TAG_INPUT, HID_DATA | HID_VARIABLE | HID_ABSOLUTE),
	ITEM1(TAG_REPORT_COUNT, 1),
	ITEM1(TAG_REPORT_SIZE, 5),
	ITEM2(TAG_INPUT, HID_CONSTANT|HID_VARIABLE),
	ITEM1(TAG_USAGE_PAGE, USAGE_PAGE_GENERIC_DESKTOP),
	ITEM1(TAG_USAGE, USAGE_DV_X),
	ITEM1(TAG_USAGE, USAGE_DV_Y),
	ITEM1(TAG_USAGE, USAGE_DV_WHEEL),
	ITEM1(TAG_LOGICAL_MIN, 256-127),
	ITEM1(TAG_LOGICAL_MAX, 127),
	ITEM1(TAG_REPORT_COUNT, 3),
	ITEM1(TAG_REPORT_SIZE, 8),
	ITEM2(TAG_INPUT, HID_DATA | HID_VARIABLE | HID_RELATIVE),
	ITEM0(TAG_END_COLLECTION)
#endif
      };
